...
public class AppUserProfileEditDTO {
    ...
    String lastName;
    @NotNull(message = "{form.field.dateOfBirth.error.notBlank.message}")
    ...
    public static class AdminAppUserProfileEditDTOBuilder {
        private String currentProfileImageData;
        ...
        public AdminAppUserProfileEditDTOBuilder currentProfileImageData(String currentProfileImageData) {
            this.currentProfileImageData = currentProfileImageData;
            return this;
        }
